...
ALLOWED_HOSTS = _env_list(
    ...
    "127.0.0.1,localhost,.onrender.com" if DEBUG else "",
)
...
# CORS
CORS_ALLOW_ALL_ORIGINS = DEBUG and _env_bool("DJANGO_CORS_ALLOW_ALL_ORIGINS", False)
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Jenga Connect API",
    "DESCRIPTION": "Jenga Connect API documentation.",
    "VERSION": "1.0.0",
