...
from core.services import normalize_phone_number
    ...
    def validate_phone(self, value):
        ...
        if not normalized:
            raise serializers.ValidationError(
                "Use a valid phone number (07XXXXXXXX or 255XXXXXXXXX)."
            )
        return normalized
...
class PlaceOrderSerializer(serializers.Serializer):
    fundi_id = serializers.UUIDField()
    delivery_area = serializers.CharField(max_length=255, allow_blank=False)
    delivery_address_note = serializers.CharField(
